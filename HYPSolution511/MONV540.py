def MONV540_UI(Mode):
    ...
    ## Set a project title
    st.title('Monaco IntelliTemplate V540 for Unity ('+ Mode +' Mode)')
...
def MONV540_UI_DECODE_V1():
    ...
    ## Set a project title
    st.title('Monaco IntelliTemplate V540 for Unity')

    ## Set 
    st.header('Monaco Treatment Plan Template (V540) Decode')
    ## ====upload your electronic protocol==== ##
    uploaded_file_protocol = st.file_uploader("Please Upload Treatment Plan Template", type=["xlsx","csv"])
